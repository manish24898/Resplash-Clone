...
import AutoWallpaperScreen from '../screens/AutoWallpaperScreen';
import SupportDevelopmentScreen from '../screens/SupportDevelopmentScreen';
...
const actionMenu = {
  ...
  collections: [
    ...
    },
    {
      ...
      icon: (
        <MaterialCommunityIcons name="star-circle" color="black" size={20} />
      ),
    },
  ],
};
...
const HomeStackNavigator = ({navigation, route}) => {
  ...
  const [collectionsFunc, setCollectionsFunc] = useState(
    actionMenu.collections[0],
  );
